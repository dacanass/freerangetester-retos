...
| 9 | Verificar que al ingresar caracteres especiales en el campo Nombre se muestra un mensaje de error |
| 10 | Verificar que al ingresar un nombre con espacios en blanco al inicio o al final en el campo Nombre se muestra un mensaje de error |
| 11 | Verificar que al ingresar un nombre con espacios en blanco entre las letras/numeros en el campo Nombre se muestra un mensaje de error |
| 12 | Verificar que el mensaje de error en el campo Nombre se muestra |
| 13 | Verificar que el mensaje de error en el campo Nombre desaparece al corregir el error |
